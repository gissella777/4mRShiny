...
## UI Structure  
&nbsp;  
**Great!** Now that we know why and what a UI is, let's learn how to create one. We're going to start with how to use Shiny function to layout the different sections of an interface (i.e., a header, footer, etc.).  
&nbsp;  
...
<p>So I know what you're wondering, what kind of arguments can I include and what do they do??
  ...
  <ul>
  <li>Text Elements</li>
  <li>Layout Functions (i.e., create a sidebar or header)</li>
  <li>Static Elements (i.e., logo, graphics, etc.)</li>
  <li>HTML/CSS</li>
...
<p>The following table contains key basic Shiny text functions which you include within the fluidpage(...) function.</p>
...
#insert link to app(not uploaded but has been created)

&nbsp;  

<p2>Shiny UI Layout Functions</p2>
