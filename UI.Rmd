...
The following table contains  the various layout options that you can use. It is not an exhaustive list but does contain the functions you are most likely to need or come across. </p>
...
<p>
You can embed cretain functions inside of others, such as tabPanel() inside of tabsetPanel() or the use of mainPanel() and sidebarPanel() inside of sidebarLayout(). And yes, you could even embed sidebarLayout() inside of tabsetPanel()!
</p>
