...
As you play around, notice how the graph reacts - both axis labels change and the plot itself changes. This is possible due to reactivity (i.e., by providing the input variables, the output graph can be created). To see what is happening under the hood, let's start with the following code:
