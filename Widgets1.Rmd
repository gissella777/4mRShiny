...
<ul>
<li><p>**inputID:** This argument is the name that you will use for this widget. It must be unique because it is the 'key' that the server calls on to access the value of the widget. This is very similar to a macro variable in SAS (must be unique and contains a value or string). (*required arg*)</p></li>
